  ...
  <Layout page="7">
    ...
    <List bordered itemLayout="vertical" size="large">
      <List.Item key="2048" extra={<img width={272} alt="2048" src="https://res.cloudinary.com/astrolht31/image/upload/v1548265775/img/Screenshot_2019-01-23_2048.png"></img>}>
        <List.Item.Meta avatar={<Avatar alt="avatar" src="https://res.cloudinary.com/astrolht31/image/upload/v1568557158/img/2048-icon.ico"></Avatar>} title={<a href="/2048">2048</a>} description="Assemblez les nombres et obtenez la case 2048 !"/>
      ...
      <List.Item key="Mario" extra={<img width={272} alt="mario" src="https://res.cloudinary.com/astrolht31/image/upload/v1548423341/img/Screenshot_2019-01-25_Mario_1.png"></img>}>
        <List.Item.Meta avatar={<Avatar alt="avatar" src="https://res.cloudinary.com/astrolht31/image/upload/v1568562787/img/mario-icone.png"></Avatar>} title={<a href="/mario">Mario</a>} description="Ceci est un clone de Infinite Mario, écrit en JavaScript pour les navigateurs Web utilisant HTML5."/>
